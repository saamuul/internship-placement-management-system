...
public class Student extends User{
    ...
    private List<InternshipApplication> appliedInternships; //Will this change..? As this will be blank every time terminal resets too
    ...
    public Student(String userID, String name, int yearOfStudy, String major){
        ...
        this.major = major;
        this.appliedInternships = new ArrayList<>(); //Prob need change later? It will be blank every time terminal resets
    ...
    public void applyForInternship(String internshipID){
        ...
        // Short-form for each file (use repository CSV filenames)
        String opportunityFile = "Internship_Opportunity_List.csv";
        String applicationFile = "Internship_Applications_List.csv";

        //Find the internship with internshipID from the csv file  (maybe become another function?)
        ...
        //(maybe another function that helps count..? Or maybe just use the list if it is updated at the start..?)
