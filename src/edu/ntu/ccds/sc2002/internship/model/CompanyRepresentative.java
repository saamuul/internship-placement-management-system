...
public class CompanyRepresentative extends User {
    ...
    public CompanyRepresentative(String userID, String name, Company company, String department, String position,
            String email) {
        super(userID, name);
    ...
    public InternshipOpportunity createInternshipOpportunity(String title, String description, Level level,
            String preferredMajor, String applicationOpenDate, String applicationClosingDate, int numOfSlots,
            boolean visibility) {
        InternshipOpportunity oppo1 = new InternshipOpportunity(title, description, preferredMajor, applicationOpenDate,
                applicationClosingDate, this, numOfSlots, visibility, level);
